...
#define __master_minstance__i__
  ...
  public:
    ...
    count_t(const count_t& _value) : _pd__initialised(0) {
      if (_value._pd__initialised) {
        if ((_pd__default = _value._pd__default)) {
          ulong_value(_value.ulong_value());
        }
        else {
          switch(_value._pd__d) {
            case vshort: short_value(_value.short_value()); break;

            case vlong: long_value(_value.long_value()); break;

            case vlong_long: long_long_value(_value.long_long_value()); break;
